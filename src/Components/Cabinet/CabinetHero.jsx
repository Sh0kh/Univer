        ...
        <section className="cabinetHero mt-[30px] p-[20px]">
            <div className="Container">
                <div className="cabinet_face flex items-center justify-start gap-[30px]">
                    <img src={foto} alt="" />
                    <h1 className='font-semibold text-[20px]  text-[#0a0d12]'>Toshkent kimyo-texnologiya instituti Yangiyer filiali direktori <span className='text-[#2d31a6]'>Xakimov Zafar Tulyaganovichning</span>
                    <br />
                    virtual qabulxonasi</h1>
                </div>
