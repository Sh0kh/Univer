  ...
  return (
    <div className="footerbot  mt-[90px] flex items-start justify-between">
      ...
      <div className="social_footer flex items-center justify-between gap-[20px]">
        <a className="text-[30px] text-[#717680]" href="https://t.me/tkti_yangiyerf" target="_blank" rel="noopener noreferrer">
        ...
        <a className="text-[30px] text-[#717680]" href="https://instagram.com/tkti_yangiyer?utm_medium=copy_link" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1M12 9a3 3 0 1 0 0 6a3 3 0 0 0 0-6m-5 3a5 5 0 1 1 10 0a5 5 0 0 1-10 0" clipRule="evenodd"></path></svg>
        </a>
        <a className="text-[30px] text-[#717680]" href="https://youtube.com/channel/UCKSfVjm1xsSyCdbAB5kt7Uw" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.facebook.com/tktiyangiyer" target="_blank" rel="noopener noreferrer">
