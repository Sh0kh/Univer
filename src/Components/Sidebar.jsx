...
const Sidebar = () => {
    ...
    return (
        <div
            class="relative flex h-screen border-r-[2px] border-[black] w-full max-w-[20rem] flex-col  bg-[#A79684] bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
            <div class="p-4 mb-2">
            </div>
