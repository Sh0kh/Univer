...
<span className="text-[#181d27] text-[18px] ">
                         Professor (Aniq fanlar)
                         </span>
                         <div className="aniq_div">
                         <span className="aniq"> • Matematika va informatika fakulteti</span>

                         </div>
                       </div>
                      <h4 className="mb-[10px]"> Biz hozirgi kunda malakali va ko’p yillik tajribaga ega professor o‘qituvchi izlamoqdamiz</h4>
...
<span className="text-[#181d27] text-[18px] ">
                        ...
                        <div className="aniq_div1">
                        <span className="aniq1"> • Matematika va informatika fakulteti</span>
...
<span className="text-[#181d27] text-[18px] ">
                        ...
                        <div className="aniq_div2">
                        <span className="aniq2"> • Matematika va informatika fakulteti</span>
...
<span className="text-[#181d27] text-[18px] ">
                        ...
                        <div className="aniq_div3">
                        <span className="aniq3"> • Matematika va informatika fakulteti</span>
...
<span className="text-[#181d27] text-[18px] ">
                        ...
                        <div className="aniq_div4">
                        <span className="aniq4"> • Matematika va informatika fakulteti</span>
