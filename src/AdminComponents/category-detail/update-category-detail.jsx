...
export function UpdateCategoryDetail({ categoryData, onCategoryUpdated }) {
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
      ...
      onCategoryUpdated();
      handleOpen();
      sweetAlert("Kategoriya detail yangilandi", "success");
    } catch (error) {
      setOpen(false);
      console.error("Kategoriya detail yangilashda xatolik:", error);
      ...
      <Dialog open={open} handler={handleOpen} size="sm" className="p-4">
        <DialogHeader className="relative">
          <Typography variant="h4" color="blue-gray">
            Kategoriya Detailni Tahrirlash
          </Typography>
          <IconButton
            size="sm"
            variant="text"
